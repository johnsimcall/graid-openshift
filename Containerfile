...
RUN dnf -y install automake dialog dkms gcc ipmitool make mdadm mokutil pciutils tar vim wget sg3_utils sqlite-libs gcc-c++ gcc kernel-devel kernel-headers
